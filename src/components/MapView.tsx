      ...
      <div className="absolute inset-0 flex items-center justify-center" style={{ zIndex: 1 }}>
        <div className="relative w-full h-full">
          ...
          {showVideoControls && videoParams && (
            <div className="absolute z-10" style={getVideoStyle()}>
              <div className="relative">
                <video ref={videoRef} className="max-w-md rounded shadow-2xl" loop muted playsInline
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 hover:opacity-100 transition-opacity">
                  <button onClick={togglePlay} className="w-16 h-16 bg-white/80 rounded-full flex items-center justify-center hover:bg-white transition-colors">
          ...
          {showVideoControls && (
            <div className="absolute top-4 left-4 z-50 bg-white rounded-lg shadow-lg p-3 flex items-center gap-3">
              ...
              <button onClick={onClearVideo} className="p-1 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded">
                <X size={16} />
              </button>
            </div>
          )}
